...
const Modal = ({ isOpen, setIsOpen, showFeedback }) => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('gmail', 'alan_ai', e.target, 'user_fsB11uS6uDeJaVNcnbgqM')
    ...
    if (isOpen && showFeedback) {
        ...
        <div className={classes.paper}>
            <Typography variant="h3">Something went wrong? Let us know. This is a work in progress.</Typography>
            <br />
        ...
        <div className={classes.paper}>
            ...
            <Typography variant="h5">Request by Categories</Typography>
            <div className={classes.chipContainer}>{['Business', 'science', 'arts', 'sports','technology','entertainment', 'general', 'health'].map((category) => <Chip label={category} color="primary" className={classes.chip} />)}</div>
            </div>
            ...
            <Divider />
            <div className={classes.infoContainer}>
            <Typography variant="h5">Request by Terms</Typography>
            <div className={classes.chipContainer}>{['Election', 'Bitcoin', 'Apple', 'Smartphones'].map((term) => <Chip label={term} color="primary" className={classes.chip} />)}<Chip label="...and more" className={classes.chip} /></div>
            </div>
            ...
            <Divider />
            <div className={classes.infoContainer}>
            <Typography variant="h5">Request News Source</Typography>
